<template>
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app clipped>
      <v-list dense>
        <v-list-item :to="'/'" link>
          ...
          <v-list-item-content>
            <v-list-item-title>SWRV</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item :to="'/CheckBody'" link>
          <v-list-item-action>
    ...
    <v-footer app>
      ...
      <span>(주) 스월브 | CEO : 윤지현 | LINK : www.swrvio.com, 부산 남구 전포대로 133, 제오피스호 13층(문현동) | CONTACT : +82 10-9520-3919</span>
    </v-footer>
  </v-app>
</template>
